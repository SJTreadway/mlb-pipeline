...
_RETROSHEET_GH_URL = 'https://raw.githubusercontent.com/chadwickbureau/retrosheet/master/seasons/{}/GL{}.TXT'
GAMELOG_COLUMNS = [
...
def season_game_logs(season):
    ...
    s = get_text_file(_RETROSHEET_GH_URL.format(season, season))
